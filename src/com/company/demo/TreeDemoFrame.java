...
import com.company.BSTree.BSTree;
import com.company.BSTree.SimpleBSTree;
import com.company.BSTree.SimpleBSTreeMap;
import com.company.BinaryTreeAlgorithms;
...
//                    showSystemOut(() -> {
//                        ru.vsu.cs.course1.tree.demo.MapTest.testCorrect(map);
//                    });
//                } catch (Exception e) {
//                    SwingUtils.showErrorMessageBox(e);
//                }
